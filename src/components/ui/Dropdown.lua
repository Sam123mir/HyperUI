...
function DropdownMenu.New(Config, Dropdown, Element, CanCallback, Type)
    ...
    Dropdown.UIElements.MenuCanvas = New("Frame", {
        ...
        Parent = Config.HyperUI.DropdownGui,
        AnchorPoint = Vector2.new(1,0),
    }, {
    ...
    function UpdatePosition()
        ...
        local buttonRight = button.AbsolutePosition.X + button.AbsoluteSize.X
        local menuHeight = menu.AbsoluteSize.Y
        local viewportHeight = Camera.ViewportSize.Y
        
        local spaceBelow = viewportHeight - buttonBottom - 10
        local spaceAbove = button.AbsolutePosition.Y - 10
        ...
        if spaceBelow >= menuHeight or spaceBelow >= spaceAbove then
            ...
            menu.Position = UDim2.new(
                0, buttonRight,
                0, buttonBottom + Element.MenuPadding
            )
        else
            -- Open upward
            ...
            menu.Position = UDim2.new(
                0, buttonRight,
                0, button.AbsolutePosition.Y - Element.MenuPadding
            )
        end
    end
